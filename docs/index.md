...
* I developed an atomistic model for electron-phonon interactions in twisted bilayer graphene and used it to study temperature and filling dependent resistivity ([arxiv](https://arxiv.org/abs/2603.14800))
* I studied electronic localization by anharmonic lattice dynamics in halide perovskites ([Phys. Rev. Materials](https://journals.aps.org/prmaterials/abstract/10.1103/PhysRevMaterials.5.085404))
